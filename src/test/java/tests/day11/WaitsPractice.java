...
public class WaitsPractice {
    ...
    public void test1(){
        ...
        //we apply it once, it always works
    ...
    public void test2(){
        driver.findElement(By.linkText("Dynamic Loading")).click();
        //select Example #1 //a[contains(text(),'Example 1'
        ...
        //this is a weblelement that represents submit button
    ...
    public void test3(){
        ...
        WebElement userNameInputBox = driver.findElement(By.id("username"));
        //wait until that username input box will be visible
        wait.until(ExpectedConditions.visibilityOf(userNameInputBox));
        //enter username
        userNameInputBox.sendKeys("tomsmith");
        ...
        //wait for password inputbox to become visible
        wait.until(ExpectedConditions.visibilityOf(passwordInputBox));
        passwordInputBox.sendKeys("SuperSecretPassword");
        //this is a weblelement that represents submit button
        WebElement submit = driver.findElement(By.cssSelector("button[type='submit']"));
